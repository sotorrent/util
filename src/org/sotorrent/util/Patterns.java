...
public class Patterns {
    ...
    public static final Pattern rootDomain;
    ...
    public static String getRootDomain(URL url) {
        Matcher rootDomainMatcher = Patterns.rootDomain.matcher(url.getHost());
    ...
    public static String getFragmentIdentifier(URL url) {
